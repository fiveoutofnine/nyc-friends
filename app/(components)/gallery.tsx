      ...
      >
        ...
        >
          <Accordion.Item value="text">
            ...
            <Accordion.Content className="font-abc-favorit flex-wrap whitespace-pre-wrap text-3xl data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
